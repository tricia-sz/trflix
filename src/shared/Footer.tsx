    ...
    return (
        <footer className="bg-slate-950 justify-center items-center py-8 ">
            <Container className="flex  flex-col justify-center items-center" >
                ...
                <span className="text-sm text-slate-500 bg-slate-950  font-mono  w-full flex items-center justify-center tracking-wide hover:text-slate-500 cursor-pointer">
